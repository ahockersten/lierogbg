...
# new DRF-based stuff begins here

# pylint: disable=no-member,too-many-ancestors,invalid-name

"""
Recruitment - Views for recruitment app
"""
...
class PlayerList(generics.ListAPIView):
    """
    Class-based generic REST view for listing players
    """
