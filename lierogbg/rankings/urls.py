...
urlpatterns = patterns(
    ...
    url(r'^submit_game\/(?P<tournament_id>.*)', 'submit_game',
        name="submit_game"),
    url(r'^submit_tournament\/$', 'submit_tournament',
        name="submit_tournament"),
    url(r'^tournaments\/$', 'tournaments', name="tournaments"),
    url(r'^update_total_ante\/$', 'update_total_ante',
